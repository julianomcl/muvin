class UserConfigurationController < ApplicationController
  ...
  def createlastfmaccountsync
    ...
    redirect_to 'http://www.last.fm/api/auth/?api_key=5da1c00d06ef449b8c672b4be3ebda79&cb=' + request.base_url + root_url #url_for(:only_path => false) #request.base_url #criar helper para key api
  end
